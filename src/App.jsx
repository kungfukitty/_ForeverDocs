...
// keep paths/casing exactly as in your repo
...
/** ---------- Inline helpers so no external component imports required ---------- */
...
function WaitlistInline() {
  ...
  const submit = async (e) => {
    ...
    } catch (err) { console.error(err); setStatus('err') }
  }
    ...
    <div className="card p-4 mt-4">
      <form onSubmit={submit}>
        <div className="flex gap-2">
          <input className="input flex-1" placeholder="Enter your email" value={email} onChange={(e)=>setEmail(e.target.value)} type="email" required />
    ...
    <>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-8">
          <div className="card p-6">
            <p className="text-ink/90">
              In the American South, there are over <span className="font-semibold">1.6 million acres</span> of land known as heirs' property.
              It’s land owned by Black families, often passed down since Reconstruction, but without a clear, legal title. When the owner dies,
              if just one of the dozens of descendants can't be found or is pressured to sell, the entire property can be forcibly sold at a
              fraction of its value.
            </p>
            <p className="text-muted mt-4">
              This isn't a rare loophole; it's a primary driver of involuntary Black land loss, costing families billions in generational wealth.
              The root cause? A missing will. A misplaced deed. A system that preys on disorganized paper records. This is how wealth is systematically
              erased—not with a bang, but with a lost document.
            </p>
          </div>
          <div className="card p-6">
      ...
      <section id="solution" className="section py-16">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-8">
          <div className="card p-6">
            <p className="text-ink/90">
              {cfg.siteName} is a free digital vault designed to stop this bleeding. We give families a simple, secure place to store their most
              important documents—the will, the deed, the insurance policy.
            </p>
            <p className="text-muted mt-4">
              But technology alone is not enough. Trust is everything. That's why our distribution isn't an app store link; it’s a QR code in the
              hands of a pastor, a barber, or a funeral home director. We go where our community already is, providing a tool that’s as easy to use
              as taking a picture. You can designate your heirs with a tap, ensuring the right people get the right information at the right time.
            </p>
            <p className="text-muted mt-4">
      ...
      {/* WHY BLOCKCHAIN (your exact copy) */}
      <section id="blockchain" className="section py-16">
        ...
        <p className="text-muted mt-4 max-w-3xl">
          So, how do we make this promise permanent and trustworthy? How do we build a system that our community can own, and that no corporation
          or entity can ever take away? That is the only reason we use the blockchain.
        </p>
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-8">
          <div className="card p-6">
            ...
            <p className="text-muted mt-3">
              When a family secures their vault, they can mint a Digital Family Crest on the blockchain. Think of it as a digital flag planted on
              a specific date, creating a public, tamper-proof timestamp. It says to the world, "On this day, the Carter family secured their legacy."
              It contains no private data, but it serves as an unforgettable, un-erasable proof of preparedness that can be a powerful tool against any
          ...
          <div className="card p-6">
            ...
            <p className="text-muted mt-3">
              Our nonprofit runs on a revolutionary funding model. A sponsor—be it a foundation, a church, or a Web3 protocol—doesn't just donate to us.
              They can publicly "Sponsor 1,000 Family Crests in Tennessee." Because it happens on a public blockchain, everyone can see the funds were
              used to help 1,000 specific families get protected. It’s radical transparency. It keeps us accountable to the community we serve, not just
              to our donors.
            </p>
